...
struct HomeView: View {
    ...
    // MARK: - VARIABLES
        ...
        // MARK: Colors
    let backgroundColor: Color = Color.hexToColor(hex: "#1C1C1E")
    let greyTextColor: Color = Color.hexToColor(hex: "#98989F")
    let blueTextColor: Color = Color.hexToColor(hex: "#0A84FF")
